...
for source_user in ['1', '5', '6']:
    for target_user in ['1', '5', '6']:
        # /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        for index, a_act in enumerate(activities_required):
            ...
            with open(DATASET_NAME + '_' + a_act + '_' + str(source_user) + '_' + str(Num_Seconds) + '_' + str(
                ...
                Model_a_act_s = HMM.HMM_with_specified_I_T_Matrix(DATASET_NAME, bags=a_act_source_bags, user='source', n_state=n_state,
            ...
            with open(DATASET_NAME + '_' + a_act + '_' + str(target_user) + '_' + str(Num_Seconds) + '_' + str(
                ...
                Model_a_act_t = HMM.HMM_with_specified_I_T_Matrix(DATASET_NAME, bags=a_act_target_bags, user='target', n_state=n_state,
                                                  Cov_Type=Cov_Type, activities_required=a_act)
        ...
        pred, acc = tsot.fit_predict_for_HMM(xns=np.array(s_list_mean).reshape(n_state * len(activities_required), n_feature),
